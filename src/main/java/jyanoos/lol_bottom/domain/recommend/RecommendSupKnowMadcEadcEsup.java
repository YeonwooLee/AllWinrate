...
public class RecommendSupKnowMadcEadcEsup implements Comparable<RecommendSupKnowMadcEadcEsup>{
    String mSup; //임의의 추천받을 서폿
    String mAdc; //입력받은 아군원딜
    String eAdc; //입력받은 상대원딜
    String eSup;//입력받은 상대서폿

    String mSupE; //임의의 추천받을 서폿
    String mAdcE; //입력받은 아군원딜
    ...
    public RecommendSupKnowMadcEadcEsup(int whole, int win, float winrate) {
        this.whole = whole;
        this.win = win;
    ...
    @Override
    public int compareTo(RecommendSupKnowMadcEadcEsup o) {
        //this쪽이 승률이 높다면 -1 리턴
