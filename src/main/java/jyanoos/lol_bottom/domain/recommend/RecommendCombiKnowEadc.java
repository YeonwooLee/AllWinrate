...
public class RecommendCombiKnowEadc implements Comparable<RecommendCombiKnowEadc>{
    String mAdc; //임의의 원딜
    String mSup; //임의의 서폿
    ...
    public RecommendCombiKnowEadc(int whole, int win, float winrate) {
        this.whole = whole;
        this.win = win;
    ...
    @Override
    public int compareTo(RecommendCombiKnowEadc o) {
        //this쪽이 승률이 높다면 -1 리턴
