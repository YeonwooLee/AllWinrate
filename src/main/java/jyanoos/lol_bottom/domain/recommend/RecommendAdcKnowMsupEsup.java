...
public class RecommendAdcKnowMsupEsup implements Comparable<RecommendAdcKnowMsupEsup>{
    String mAdc; //임의의 원딜
    ...
    public RecommendAdcKnowMsupEsup(int whole, int win, float winrate) {
        this.whole = whole;
        this.win = win;
    ...
    @Override
    public int compareTo(RecommendAdcKnowMsupEsup o) {
        //this쪽이 승률이 높다면 -1 리턴
